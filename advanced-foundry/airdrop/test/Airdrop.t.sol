...
contract TestAirdrop is Test {
	...
	function testAllowedUserCanClaim() public {
		...
		vm.startPrank(USER_1);
			airdrop.claim(USER_1, ALLOWED_AMOUNT_TO_CLAIM, PROOF_FOR_USER_1);
		vm.stopPrank();
	...
	function testUnallowedUserCantClaim() public {
		...
		vm.startPrank(USER_3);
			...
			airdrop.claim(USER_3, ALLOWED_AMOUNT_TO_CLAIM, PROOF_FOR_USER_1);
		vm.stopPrank();
	}
	...
	function testAllowedUserCantClaimUnallowedAmount() public {
		...
		vm.startPrank(USER_1);
			vm.expectRevert(Airdrop.Airdrop__InvalidProof.selector);
			airdrop.claim(USER_1, UNALLOWED_AMOUNT_TO_CLAIM, PROOF_FOR_USER_1);
		vm.stopPrank();
	}
